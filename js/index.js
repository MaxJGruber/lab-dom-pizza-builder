...
function renderWhiteSauce() {
  ...
  document.querySelectorAll(".sauce-white").forEach((whiteS) => {
    if (state.whiteSauce) {
...
function renderGlutenFreeCrust() {
  ...
  document.querySelectorAll(".crust-gluten-free").forEach((gfc) => {
...
function renderButtons() {
  ...
  for (let index = 0; index < activeArray.length; index++) {
    const element = activeArray[index];
    element.onclick = function () {
      activeArray[index].classList.toggle("active");
    };
  }
}
...
function renderPrice() {
  ...
  let activeArray = document.querySelectorAll(".add-on");
  console.log(activeArray);
  for (let index = 0; index < activeArray.length; index++) {
    const element = activeArray[index];
    element.onclick = function () {
      console.log(activeArray[index].classList);
      activeArray[index].classList.toggle("active");
    };
  }
}
